...
const features = [
  {
    ...
    desc: "Full CRUD with status tracking, goals, trainer assignment, and lead nurturing.",
    icon: icons.members,
  },
  {
    title: "Attendance Tracking",
    desc: "Manual, QR, or mobile check-ins filtered by tenant with daily analytics.",
    icon: icons.attendance,
  },
  {
    title: "Payment Collection",
    desc: "Cash, UPI, card, bank transfer tracking with automated plan linking.",
    icon: icons.payments,
  },
  {
    title: "AI Coaching",
    desc: "Free AI-generated workout plans, diet plans, and personalized messages.",
    icon: icons.ai,
  },
  {
    title: "WhatsApp Automation",
    desc: "Automated reminders for payments, expiring memberships, and welcome flows.",
    icon: icons.whatsapp,
  },
  {
    title: "Reports & Analytics",
    desc: "Subscription health, coaching output, retention metrics, and revenue trends.",
    icon: icons.reports,
  },
  {
    title: "Mobile App",
    desc: "Expo React Native app for attendance, payments, and member management on the go.",
    icon: icons.mobile,
  },
  {
    title: "Trainer Panel",
    desc: "Manage coaches, specialties, client allocations, and performance tracking.",
    icon: icons.trainer,
  },
];
...
const stackItems = [
  {
    name: "Vercel",
    detail: "Web hosting — free tier",
    color: "bg-slate-900 text-white",
  },
  {
    name: "Supabase",
    detail: "Database + Auth — 500MB free",
    color: "bg-emerald-600 text-white",
  },
  {
    name: "Groq",
    detail: "AI inference — 30 req/min free",
    color: "bg-orange-500 text-white",
  },
  {
    name: "Gemini",
    detail: "AI fallback — 60 req/min free",
    color: "bg-blue-500 text-white",
  },
  {
    name: "Baileys",
    detail: "WhatsApp Web — open source",
    color: "bg-green-600 text-white",
  },
  {
    name: "Expo",
    detail: "Mobile builds — free tier",
...
export default function LandingPage() {
  return (
    <main className="overflow-hidden">
          ...
          <div className="flex-1 space-y-8 animate-fade-in-up">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-xl text-lg leading-relaxed text-slate-600">
                Members, billing, AI coaching, attendance, WhatsApp automation,
                and a mobile app — shipped as a sellable SaaS on free-tier
                infrastructure.
              </p>
            </div>
      ...
      >
        <div className="mb-14 max-w-2xl animate-fade-in-up">
          ...
          <p className="mt-3 text-lg leading-relaxed text-slate-600">
            From member onboarding to AI-powered coaching — every tool a gym
            owner needs, in one place.
          </p>
        </div>
      ...
      <section id="pricing" className="bg-slate-50/80 bg-grid">
        <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-28">
          <div className="mb-14 max-w-2xl animate-fade-in-up">
            ...
            <p className="mt-3 text-lg leading-relaxed text-slate-600">
              Switch the logic to Razorpay or Stripe later. The SaaS already
              supports starter, growth, and scale entitlements out of the box.
            </p>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mb-6 space-y-2">
                      <h3
                        className={`text-lg font-semibold ${isPopular ? "text-white" : "text-slate-900"}`}
                      >
                        {plan.name}
                      </h3>
                      <p
                        className={`text-sm ${isPopular ? "text-slate-300" : "text-slate-500"}`}
                      >
                    ...
                    <div className="mb-6">
                      <span
                        className={`text-5xl font-extrabold tracking-tight ${isPopular ? "text-white" : "text-slate-900"}`}
                      >
                        ₹{plan.amount}
                      </span>
                      <span
                        className={`ml-1 text-sm ${isPopular ? "text-slate-400" : "text-slate-500"}`}
                      >
                        /month
                      </span>
                    </div>
                    <ul className="mb-8 flex-1 space-y-3">
                      {plan.features.map((feature: string) => (
                        <li key={feature} className="flex items-start gap-3">
                          <span
                            className={`mt-0.5 ${isPopular ? "text-brand-300" : ""}`}
                          >
                            {icons.check}
                          </span>
                          <span
                            className={`text-sm ${isPopular ? "text-slate-200" : "text-slate-600"}`}
                          >
                            {feature}
                          </span>
                        </li>
            ...
            <div className="relative grid gap-12 lg:grid-cols-[1.4fr_1fr] lg:items-center">
              <div className="space-y-6 animate-fade-in-up">
                ...
                <p className="max-w-lg text-lg leading-relaxed text-slate-300">
                  GymFlow runs entirely on free-tier services. No monthly
                  hosting costs to run the demo or onboard your first customers.
                </p>
              ...
              <div className="grid gap-3 animate-slide-right delay-200">
                {stackItems.map((item) => (
                  ...
                  >
                    <span
                      className={`flex h-8 w-8 items-center justify-center rounded-lg text-xs font-bold ${item.color}`}
                    >
                      {item.name.charAt(0)}
                    </span>
                    <div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 md:px-8 md:py-20">
          <div className="text-center animate-fade-in-up">
            ...
            <p className="mx-auto max-w-2xl text-xl font-medium leading-relaxed text-slate-700 md:text-2xl">
              &ldquo;GymFlow replaced three separate tools we were paying for.
              The AI coaching feature alone saves us hours every week.&rdquo;
            </p>
            <div className="mt-6">
              <p className="font-semibold text-slate-900">Aarav Sharma</p>
              <p className="text-sm text-slate-500">
                Owner, GymFlow Demo Fitness — Bengaluru
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 md:px-8">
        <div className="rounded-2xl bg-gradient-to-r from-brand-600 to-brand-700 px-8 py-12 text-center shadow-lg md:px-16 md:py-16 animate-scale-in">
          ...
          <p className="mx-auto mt-3 max-w-lg text-brand-100">
            Get started in minutes. No credit card required. Deploy on free-tier
      ...
      <section
        id="download-apk"
        className="border-y border-slate-200/60 bg-slate-50/80"
      >
        <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-28">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="animate-fade-in-up">
              ...
              <h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-950 md:text-4xl">
                GymFlow on your phone.{" "}
                <span className="gradient-text">Download the APK.</span>
              </h2>
              <p className="mt-3 text-lg leading-relaxed text-slate-600">
                Get the GymFlow mobile app for Android. Manage your gym from
                anywhere — check attendance, view member status, and track
                payments on the go.
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <a
                  href="https://expo.dev/artifacts/eas/mmUgBVLCg7NSpwHwBpn2AA.apk"
                  target="_blank"
                ...
                <a
                  href="https://expo.dev/accounts/soloxpiyush/projects/gymflow-mobile/builds"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <div className="relative rounded-3xl bg-slate-950 p-8 shadow-2xl ring-1 ring-white/10 lg:p-10">
                ...
                <div className="relative space-y-6">
                  ...
                  <div className="flex items-center gap-3 rounded-xl bg-brand-600/20 px-4 py-3">
                    <span className="text-brand-400">{icons.zap}</span>
                    <p className="text-sm font-medium text-brand-200">
                      Free download — No signup required to install
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid gap-12 md:grid-cols-4">
            <div className="md:col-span-2">
              ...
              <p className="mt-3 max-w-sm text-sm leading-relaxed text-slate-500">
                All-in-one gym management SaaS built on free-tier services.
                Members, billing, AI coaching, attendance, and WhatsApp — one
                platform.
              </p>
            </div>
            <div>
